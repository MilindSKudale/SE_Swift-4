...
public class UIDropDown: UIControl {
    ...
    public var optionsSize: CGFloat = 14.0
    ...
    fileprivate func setup() {
        ...
        arrow = Arrows(origin: CGPoint(x: arrowPadding,
                                      y: arrowPadding),
        ...
        self.layer.borderColor = APPBLUECOLOR.cgColor
...
class Arrows: UIView {
    ...
    init(origin: CGPoint, size: CGFloat) {
        super.init(frame: CGRect(x: origin.x, y: origin.y, width: 15, height: 15))
    }

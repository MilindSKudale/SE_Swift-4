...
open class DropDown : UITextField{
   ...
   @IBInspectable public var selectedRowColor: UIColor = .groupTableViewBackground
...
//            //arrow.frame = CGRect(x: 10, y: center.y - arrowSize/2, width: arrowSize, height: arrowSize)
//            Arrows.ind arrowSize = arrowSize
//        }
//    }
    ...
    func setupUI () {
        ...
        arrow = Arrows(origin: CGPoint(x: center.x - 15/2,y: center.y - 15/2),size: 15)

...
class StepByStepGuide : UIViewController, UIDocumentInteractionControllerDelegate {
...
extension StepByStepGuide : UITableViewDelegate, UITableViewDataSource {

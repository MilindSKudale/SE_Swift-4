...
class MyProspectsView: SliderVC {
    ...
    override func viewDidLoad() {
        ...
        actionButton.addItem(title: "", image: #imageLiteral(resourceName: "add_contact")) { item in
            ...
            let vc = storyboard.instantiateViewController(withIdentifier: "idAddProspectView") as! AddProspectView
...
extension MyProspectsView : DAOSearchBarDelegate, UITextFieldDelegate {
...
extension MyProspectsView : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction.init(style: UIContextualAction.Style.destructive, title: "Delete", handler: { (action, view, completion) in
            ...
            let alertVC = PMAlertController(title: "", description: "Do you want to delete this prospect?", image: nil, style: .alert)
...
extension MyProspectsView {
    ...
    @IBAction func actionAssignCampaignsToAllRecords(_ sender: UIButton) {
        ...
        if arrSelectedRecords.count > 0 && arrSelectedRecords.count <= 50 {
            ...
            OBJCOM.hideLoader()
            let alertVC = PMAlertController(title: "", description: "You can assign email campaign only 50 prospects. Please select prospects less than 50.", image: nil, style: .alert)
    ...
    func exportCSVAPI(crmFlag : String){
        ...
        OBJCOM.modalAPICall(Action: "sendCsvbyEmailCrm", param:dictParam as [String : AnyObject],  vcObject: self) {
            ...
            if success == "true"{
                ...
                let alertVC = PMAlertController(title: "", description: "Prospects exported successfully.", image: nil, style: .alert)

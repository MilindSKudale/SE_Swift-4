...
class EditCustomerView: UITableViewController {
    ...
    @IBAction func actionSave(_ sender:AnyObject){
        if isValidate() == true{
            ...
            dictParam["contact_flag"] = "2" as AnyObject
            ...
            OBJCOM.modalAPICall(Action: "updateCrm", param:dictParam as [String : AnyObject],  vcObject: self){
                ...
                if success == "true"{
                    ...
                    alertVC.addAction(PMAlertAction(title: "OK", style: .default, action: { () in
                        NotificationCenter.default.post(name: Notification.Name("UpdateCustomerList"), object: nil)

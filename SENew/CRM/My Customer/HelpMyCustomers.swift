...
class HelpMyCustomers: UIViewController, EAIntroDelegate {
    ...
    @IBAction func actionBtn1(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust1")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obCust2")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obCust3")
    ...
    @IBAction func actionBtn2(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust4")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obCust5")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obCust6")
    ...
    @IBAction func actionBtn3(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust7")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obCust8")
    ...
    @IBAction func actionBtn4(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust9")
    ...
    @IBAction func actionBtn5(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust10")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obCust11")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
        introView?.skipButton.backgroundColor = APPBLUECOLOR
    ...
    @IBAction func actionBtn6(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obCust12")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obCust13")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
        introView?.skipButton.backgroundColor = APPBLUECOLOR
        introView?.skipButton.layer.cornerRadius = 15

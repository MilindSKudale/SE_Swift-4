//
//  HelpMyContacts.swift
//  SENew
//
//  Created by Milind Kudale on 18/07/19.
...
class HelpMyContacts: UIViewController, EAIntroDelegate {
    ...
    @IBAction func actionBtn1(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact1")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obContact2")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obContact3")
...
//        introView?.skipButton.layer.cornerRadius = 15.0
    ...
    @IBAction func actionBtn2(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact4")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obContact5")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obContact6")
    ...
    @IBAction func actionBtn3(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact7")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obContact8")
    ...
    @IBAction func actionBtn4(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact9")
    ...
    @IBAction func actionBtn5(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact10")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obContact11")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
        introView?.skipButton.backgroundColor = APPBLUECOLOR
    ...
    @IBAction func actionBtn6(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obContact12")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obContact13")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
        introView?.skipButton.backgroundColor = APPBLUECOLOR
        introView?.skipButton.layer.cornerRadius = 15

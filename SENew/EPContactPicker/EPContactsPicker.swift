...
open class EPContactsPicker: UITableViewController, UISearchResultsUpdating, UISearchBarDelegate {
    ...
    func inititlizeBarButtons() {
        ...
        if multiSelectEnabled {
            ...
            btn1.setTitle("Select All", for: .normal)
            ...
            btn1.addTarget(self, action: #selector(onTouchSelectButton), for: .touchUpInside)
            let item1 = UIBarButtonItem(customView: btn1)
            
            let btn2 = UIButton(type: .custom)
            btn2.setTitle("Done", for: .normal)
            btn2.setTitleColor(.blue, for: .normal)
            btn2.titleLabel?.font = UIFont.systemFont(ofSize: 15)
            btn2.frame = CGRect(x: 0, y: 0, width: 30, height: 30)
            btn2.addTarget(self, action: #selector(onTouchDoneButton), for: .touchUpInside)
             ...
             //   var EPContactsArray = [EPContact]()
                ...
                do {
                    try contactsStore?.enumerateContacts(with: contactFetchRequest, usingBlock: { (contact, stop) -> Void in
                        ...
                        let firstLetter = contact.givenName
                        if firstLetter.containsAlphabets() {
                            key = firstLetter.prefix(1).uppercased()
                        }
                        ...
                        self.allContacts.append(epcontact)
    ...
    func allowedContactKeys() -> [CNKeyDescriptor]{
        ...
        return [CNContactNamePrefixKey as CNKeyDescriptor,
                ...
                CNSocialProfileServiceLinkedIn as CNKeyDescriptor]
    }
    ...
    @objc func onTouchSelectButton(_ sender : UIButton!) {

...
open class EPContact {
    ...
    public init (contact: CNContact) {
      ...
      //  let pAddress = contact.postalAddresses[0]
        address = "" //pAddress.value.street
        city = "" //pAddress.value.city
        state = "" //pAddress.value.state
        country = "" //pAddress.value.country
        zip = "" //pAddress.value.postalCode

//
//  ScratchPadNotificationView.swift
//  SENew
//
...
class ScratchPadNotificationView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tblNotification.estimatedRowHeight = 67.0
...
extension ScratchPadNotificationView : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "idSPNotificationDetails") as! SPNotificationDetails
        if indexPath.section == 0 {
            if arrTodaysNotiData.count > 0 {
...
extension ScratchPadNotificationView {

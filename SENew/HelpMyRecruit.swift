...
//  SENew
//
//  Created by Milind Kudale on 24/07/19.
...
class HelpMyRecruit: UIViewController, EAIntroDelegate {
    ...
    @IBAction func actionBtn1(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit1")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obRecruit2")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obRecruit3")
    ...
    @IBAction func actionBtn2(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit4")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obRecruit5")
        let ingropage3 = EAIntroPage.init(customViewFromNibNamed: "obRecruit6")
    ...
    @IBAction func actionBtn3(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit7")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obRecruit8")
    ...
    @IBAction func actionBtn4(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit9")
    ...
    @IBAction func actionBtn5(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit10")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obRecruit11")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
            introView?.skipButton.backgroundColor = APPBLUECOLOR
            introView?.skipButton.layer.cornerRadius = 15.0
    ...
    @IBAction func actionBtn6(_ sender:UIButton){
        let ingropage1 = EAIntroPage.init(customViewFromNibNamed: "obRecruit12")
        let ingropage2 = EAIntroPage.init(customViewFromNibNamed: "obRecruit13")
        let introView = EAIntroView.init(frame: self.view.bounds, andPages: [ingropage1!,ingropage2!])
        introView?.delegate = self
            introView?.skipButton.backgroundColor = APPBLUECOLOR
            introView?.skipButton.layer.cornerRadius = 15.0

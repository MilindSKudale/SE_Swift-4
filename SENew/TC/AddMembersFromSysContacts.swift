//
//  AddMembersFromSysContacts.swift
//  SENew
//
...
class AddMembersFromSysContacts: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnAddAndStartCamp.layer.cornerRadius = 5
...
extension AddMembersFromSysContacts : UITableViewDelegate, UITableViewDataSource {
...
extension AddMembersFromSysContacts : DAOSearchBarDelegate, UITextFieldDelegate {
...
extension AddMembersFromSysContacts {
    func assignTextMembers(_ addAndAssinged:String){
        ...
        let dictParam = ["userId": userID,
                         ...
                         "txtcontactMainCampaignId":txtCampId,

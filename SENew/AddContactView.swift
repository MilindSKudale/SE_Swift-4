...
class AddContactView: UITableViewController {
...
extension AddContactView: UITextViewDelegate, GrowingTextViewDelegate {
...
//
//
//        height = (textView.text?.heightWithConstrainedWidth(width: tableView.frame.size.width, font: UIFont.systemFont(ofSize: 15)))!
//

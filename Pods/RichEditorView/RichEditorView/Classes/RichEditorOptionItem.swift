...
public enum RichEditorDoneOption: RichEditorOption {
    case clear
    
    public static let doneBtn: [RichEditorDefaultOption] = [
        .clear
    ]
    ...
    public var title: String {
        switch self {
        case .clear: return NSLocalizedString("Done", comment: "")
        }
    }
    
    public func action(_ toolbar: RichEditorToolbar) {
        switch self {
        case .clear: toolbar.editor?.endEditing(true)
        }
    }
}
